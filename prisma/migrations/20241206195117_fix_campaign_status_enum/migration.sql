...
-- AlterEnum
BEGIN;
CREATE TYPE "LeadCampaignStatus_new" AS ENUM ('New', 'Engaged', 'FollowUp_Scheduled', 'Contacted', 'Qualified', 'Converted', 'Unresposnvive', 'Disqualified', 'Re_Engaged', 'Opted_Out');
